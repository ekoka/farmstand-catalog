export const API_DOC = "https://api.productlist.io/doc/v1"

//export const TENANT_HOST_TEMPLATE = 'https://{tenant}.productlist.local:8080'
export const DOMAIN_HOST_TEMPLATE = 'https://{domain}.productlist.local:8082'
